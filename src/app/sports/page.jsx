...
const SportsPage = () => {
  ...
  return (
    <main className="absolute z-10">
      ...
      <section className="h-screen w-screen flex flex-col justify-center items-center">
        <h1 className="text-4xl sm:text-5xl font-bold mb-2 text-center">Choose Your Arena</h1>
        <p className="text-gray-300 mb-12 text-center">Select your battlefield and dominate!</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full max-w-4xl">
          {arenas.map((arena) => (
            ...
            >
              ...
              <a href={arena.link} className="self-start text-white font-medium underline hover:text-gray-400">
                Enter →
              </a>
            </div>
          ))}
