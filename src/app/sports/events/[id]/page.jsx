    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center pt-20">
        <div className="text-center">
          ...
          <Link 
            href="/sports" 
            className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105"
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <div className="bg-gray-800 rounded-2xl border border-gray-700 h-full w-full overflow-hidden">
            ...
            <div className={`h-64 bg-gradient-to-r ${gradientColors} relative`}>
              ...
              <div className="absolute top-4 right-4">
                <span className={`${isIndoor ? 'bg-red-500' : 'bg-green-500'} text-white px-4 py-2 rounded-full text-sm font-semibold`}>
            ...
            <div className="p-8">
              ...
              {/* Register Button */}
              <button className={`w-full ${buttonColor} text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg`}>
                Register for Event
              </button>
            </div>
          </div>
